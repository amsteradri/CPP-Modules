...
/*   Updated: 2024/01/11 15:10:01 by adgutier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void): _name("default"), _hitpoints(100), _energypoints(50), _attack(20)
{
    std::cout << "ClapTrap class named " << this->_name << " created with default constructor." << std::endl;
}

ClapTrap::ClapTrap(std::string const &name): _name(name), _hitpoints(100), _energypoints(50), _attack(20)
{
